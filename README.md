...
- **SPORTSONLINE** → Includes **all live events** (sports)
...
## Steps
1. Set up and run the [EasyProxy](https://github.com/nzo66/EasyProxy) by following the instructions in its repository.
